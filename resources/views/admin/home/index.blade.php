                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="chart-orders" class="chart-lg"></div>
                        </div>
                    </div>
                </div>
            </div>
...
@endsection
@push('js')
    <script src="{{ asset('') }}templates/dist/libs/apexcharts/dist/apexcharts.min.js?1692870487" defer></script>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            window.ApexCharts && (new ApexCharts(document.getElementById('chart-orders'), {
                chart: {
                    type: "bar",
                    fontFamily: 'inherit',
                    height: 240,
