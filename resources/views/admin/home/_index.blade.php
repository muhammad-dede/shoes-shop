...
<head>
    ...
    <link href="{{ asset('') }}template/dist/css/font.css" rel="stylesheet" />
</head>
            ...
            <header class="navbar navbar-expand-md sticky-top d-print-none">
                <div class="container-xl">
                    ...
                    <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                        <a href=".">
                            <img src="{{ asset('') }}template/static/logo.svg" width="110" height="32"
                    ...
                    <div class="navbar-nav flex-row order-md-last">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <a href="{{ asset('') }}template/settings.html"
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <div class="navbar">
                        <div class="container-xl">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('') }}template/">
                                        <span
                                        ...
                                        <div class="dropdown-menu-columns">
                                            <div class="dropdown-menu-column">
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/alerts.html">
                                                    Alerts
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/accordion.html">
                                                    Accordion
                                                </a>
                                                <div class="dropend">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="{{ asset('') }}template/sign-in.html"
                                                            class="dropdown-item">
                                                            Sign in
                                                        </a>
                                                        <a href="{{ asset('') }}template/sign-in-link.html"
                                                            class="dropdown-item">
                                                            Sign in link
                                                        </a>
                                                        <a href="{{ asset('') }}template/sign-in-illustration.html"
                                                            class="dropdown-item">
                                                            Sign in with illustration
                                                        </a>
                                                        <a href="{{ asset('') }}template/sign-in-cover.html"
                                                            class="dropdown-item">
                                                            Sign in with cover
                                                        </a>
                                                        <a href="{{ asset('') }}template/sign-up.html"
                                                            class="dropdown-item">
                                                            Sign up
                                                        </a>
                                                        <a href="{{ asset('') }}template/forgot-password.html"
                                                            class="dropdown-item">
                                                            Forgot password
                                                        </a>
                                                        <a href="{{ asset('') }}template/terms-of-service.html"
                                                            class="dropdown-item">
                                                            Terms of service
                                                        </a>
                                                        <a href="{{ asset('') }}template/auth-lock.html"
                                                            class="dropdown-item">
                                                            Lock screen
                                                        </a>
                                                        <a href="{{ asset('') }}template/2-step-verification.html"
                                                            class="dropdown-item">
                                                            2 step verification
                                                        </a>
                                                        <a href="{{ asset('') }}template/2-step-verification-code.html"
                                                            class="dropdown-item">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/blank.html">
                                                    Blank page
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/badges.html">
                                                    Badges
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/buttons.html">
                                                    Buttons
                                                </a>
                                                <div class="dropend">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="{{ asset('') }}template/cards.html"
                                                            class="dropdown-item">
                                                            Sample cards
                                                        </a>
                                                        <a href="{{ asset('') }}template/card-actions.html"
                                                            class="dropdown-item">
                                                            Card actions
                                                            <span
                                                                class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                        </a>
                                                        <a href="{{ asset('') }}template/cards-masonry.html"
                                                            class="dropdown-item">
                                                            Cards Masonry
                                                        </a>
                                                    </div>
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/carousel.html">
                                                    Carousel
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/charts.html">
                                                    Charts
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/colors.html">
                                                    Colors
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/colorpicker.html">
                                                    Color picker
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/datagrid.html">
                                                    Data grid
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/datatables.html">
                                                    Datatables
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/dropdowns.html">
                                                    Dropdowns
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/dropzone.html">
                                                    Dropzone
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <div class="dropend">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="{{ asset('') }}template/error-404.html"
                                                            class="dropdown-item">
                                                            404 page
                                                        </a>
                                                        <a href="{{ asset('') }}template/error-500.html"
                                                            class="dropdown-item">
                                                            500 page
                                                        </a>
                                                        <a href="{{ asset('') }}template/error-maintenance.html"
                                                            class="dropdown-item">
                                                            Maintenance page
                                                        </a>
                                                    </div>
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/flags.html">
                                                    Flags
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/inline-player.html">
                                                    Inline player
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                            ...
                                            <div class="dropdown-menu-column">
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/lightbox.html">
                                                    Lightbox
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/lists.html">
                                                    Lists
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/modals.html">
                                                    Modal
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/maps.html">
                                                    Map
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/map-fullsize.html">
                                                    Map fullsize
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/maps-vector.html">
                                                    Map vector
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/markdown.html">
                                                    Markdown
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/navigation.html">
                                                    Navigation
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/offcanvas.html">
                                                    Offcanvas
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/pagination.html">
                                                    <!-- Download SVG icon from http://tabler-icons.io/i/pie-chart -->
                                                    Pagination
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/placeholder.html">
                                                    Placeholder
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/steps.html">
                                                    Steps
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/stars-rating.html">
                                                    Stars rating
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/tabs.html">
                                                    Tabs
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/tags.html">
                                                    Tags
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/tables.html">
                                                    Tables
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/typography.html">
                                                    Typography
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/tinymce.html">
                                                    TinyMCE
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('') }}template/form-elements.html">
                                        <span
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-menu-columns">
                                            <div class="dropdown-menu-column">
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/empty.html">
                                                    Empty page
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/cookie-banner.html">
                                                    Cookie banner
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/chat.html">
                                                    Chat
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/activity.html">
                                                    Activity
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/gallery.html">
                                                    Gallery
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/invoice.html">
                                                    Invoice
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/search-results.html">
                                                    Search results
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/pricing.html">
                                                    Pricing cards
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/pricing-table.html">
                                                    Pricing table
                                                </a>
                                                <a class="dropdown-item" href="{{ asset('') }}template/faq.html">
                                                    FAQ
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/users.html">
                                                    Users
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/license.html">
                                                    License
                                                </a>
                                            </div>
                                            <div class="dropdown-menu-column">
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/logs.html">
                                                    Logs
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/music.html">
                                                    Music
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/photogrid.html">
                                                    Photogrid
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/tasks.html">
                                                    Tasks
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/uptime.html">
                                                    Uptime monitor
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/widgets.html">
                                                    Widgets
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/wizard.html">
                                                    Wizard
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/settings.html">
                                                    Settings
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/trial-ended.html">
                                                    Trial ended
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/job-listing.html">
                                                    Job listing
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/page-loader.html">
                                                    Page loader
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                ...
                                <li class="nav-item active dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-menu-columns">
                                            <div class="dropdown-menu-column">
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-horizontal.html">
                                                    Horizontal
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-boxed.html">
                                                    Boxed
                                                    <span
                                                        class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-vertical.html">
                                                    Vertical
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-vertical-transparent.html">
                                                    Vertical transparent
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-vertical-right.html">
                                                    Right vertical
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-condensed.html">
                                                    Condensed
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-combo.html">
                                                    Combined
                                                </a>
                                            </div>
                                            <div class="dropdown-menu-column">
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-navbar-dark.html">
                                                    Navbar dark
                                                </a>
                                                <a class="dropdown-item active"
                                                    href="{{ asset('') }}template/layout-navbar-sticky.html">
                                                    Navbar sticky
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-navbar-overlap.html">
                                                    Navbar overlap
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-rtl.html">
                                                    RTL mode
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-fluid.html">
                                                    Fluid
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ asset('') }}template/layout-fluid-vertical.html">
                                                    Fluid vertical
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('') }}template/icons.html">
                                        <span
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ asset('') }}template/emails.html">
                                        <span
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{ asset('') }}template/changelog.html">
                                            Changelog
                                        </a>
                            ...
                            <div class="my-2 my-md-0 flex-grow-1 flex-md-grow-0 order-first order-md-last">
                                <form action="{{ asset('') }}template/" method="get" autocomplete="off"
                                    novalidate>
                    ...
                    <div class="row row-deck row-cards">
                                            ...
                                            <div class="divide-y">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/002m.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/003m.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/000f.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/001f.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/002f.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/003f.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/006m.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/004f.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/007m.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/009m.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/010m.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/005f.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar"
                                                                style="background-image: url({{ asset('') }}template/static/avatars/006f.jpg)"></span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <a href="https://github.com/sponsors/codecalm" class="card card-sponsor"
                                target="_blank" rel="noopener"
                                style="background-image: url({{ asset('') }}template/static/sponsor-banner-homepage.svg)"
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                ...
                                <li class="list-inline-item"><a href="{{ asset('') }}template/license.html"
                        ...
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="{{ asset('') }}template/changelog.html" class="link-secondary"
                                        rel="noopener">
                                        v1.0.0-beta20
                                    </a>
                                </li>
