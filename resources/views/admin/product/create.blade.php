...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            <form action="{{ route('admin.product.store') }}" class="card" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="id_category"
                                ...
                                @foreach (allCategory() as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('id_category') == $item->id ? 'selected' : '' }}>
                                        {{ $item->name ?? '-' }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control tinymce @error('name') is-invalid @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <small class="text-danger text-error">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input name="weight" type="number"
                                    ...
                                    placeholder="Input berat produk" value="{{ old('weight') }}" />
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input name="price" type="number"
                                    ...
                                    placeholder="Input harga produk" value="{{ old('price') }}" />
                            </div>
                            @error('price')
                                <small class="text-danger text-error">
                                    {{ $message }}
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input name="discount" type="number"
                                    ...
                                    placeholder="Input diskon" value="{{ old('discount') }}" />
                                <span class="input-group-text">
                                    %
                                </span>
                            </div>
