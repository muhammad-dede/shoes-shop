...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title">{{ __('Atur Ulang Password') }}</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    <div class="register-form">
                        <div class="title">
                            <h3>{{ __('Atur Ulang Password') }}</h3>
                            <p>{{ __('Masukan password baru kamu') }}
                            </p>
                        </div>
                        <form action="{{ route('password.update') }}" class="row" method="post">
                            ...
                            <div class="button">
                                <button class="btn" type="submit">{{ __('Atur Ulang Password') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    {{-- <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Atur Ulang Password') }}</div>
